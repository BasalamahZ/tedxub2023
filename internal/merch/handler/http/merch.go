		...
		data := []MerchHTTP{
			{
				...
				Nama:      "Hoodie",
				Harga:     "Rp220.000",
				Deskripsi: "Corak yang menghangatkan diperlukan dalam keberagaman yang ada",
			...
			},
			{
				...
				Nama:      "T-shirt",
				Harga:     "Rp100.000",
				Deskripsi: "Keterbukaan melahirkan narasi yang mampu mengkolaborasikan setiap insan untuk mewujudkan penerimaan diri",
