...
import (
	...
	"github.com/tedxub2023/internal/main-ticket"
	"github.com/tedxub2023/internal/main-ticket/service"
)
...
type mainTicketDB struct {
}

// format formats database struct into domain struct.
func (tdb *mainTicketDB) format() mainTicket.MainTicket {
	t := mainTicket.MainTicket{}
